...
inventorNames = inventors.map((inventorName) => {
    return {
        first: inventorName.first,
        last: inventorName.last
    }
})
...
sortedByBirthYear = inventors.sort((element1, element2) => {
...
inventorNamedAda = inventors.find((inventorNameAda) => {
    return inventorNameAda.first === "Ada"
})
...
//  return inventor.first.split(1) + " " + inventor.last.split(1)
//})
